...
public class FeaturedProductAdapterList  extends RecyclerView.Adapter<FeaturedProductAdapterList.MyViewHolder> {
    private Context context;
    List<FeaturedProductPojo> featuredProductPojoList;

    public FeaturedProductAdapterList(Context context, List<FeaturedProductPojo> featuredProductPojoList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final FeaturedProductPojo items=featuredProductPojoList.get(position);
        ...
        {
            featuredProductPojoList.get(position).setRating("0");
        }
