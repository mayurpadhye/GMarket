...
public class DealsAdapter  extends RecyclerView.Adapter<DealsAdapter.MyViewHolder> {
    ...
    private List<DealsPjo> latestProductItemPojoList;
    NewHomeFragment homeFragmentNew;
    Context context;
    ProgressBar p_bar;

    public DealsAdapter(List<DealsPjo> latestProductItemPojoList, Context context, ProgressBar p_bar, NewHomeFragment homeFragmentNew) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        final DealsPjo items=latestProductItemPojoList.get(position);
        ...
        holder.ll_add_to_cart.setVisibility(View.GONE);
       ...
       /* Glide.with(context).load(items.getProduct_image())
        ...
        Picasso.with(context).load(items.getProduct_image()) .resize(150, 150).noFade().placeholder(context.getResources().getDrawable(R.drawable.ic_g_market_logo)).into(holder.iv_product_image);
    ...
    public void AddToWishList(final String product_id, final DealsPjo items, final int position, final SparkButton sparkButton)
    {
    ...
    public void RemoveFromWishList(final String product_id, final DealsPjo items, final int position, final SparkButton sparkButton)
    {
        p_bar.setVisibility(View.VISIBLE);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout ll_product,ll_add_to_cart;
        RatingBar ratingBar;
