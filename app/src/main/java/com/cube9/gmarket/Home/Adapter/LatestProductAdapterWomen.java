...
public class LatestProductAdapterWomen  extends RecyclerView.Adapter<LatestProductAdapterWomen.MyViewHolder> {
    private List<LatestProductItemPojo> latestProductItemPojoList;
    Context context;
    ProgressBar p_bar;

    public LatestProductAdapterWomen(List<LatestProductItemPojo> latestProductItemPojoList, Context context, ProgressBar p_bar) {
    ...
    public LatestProductAdapterWomen(List<LatestProductItemPojo> latestProductItemPojoList, Context context) {
        this.latestProductItemPojoList = latestProductItemPojoList;
        this.context = context;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final LatestProductItemPojo items=latestProductItemPojoList.get(position);
    ...
    public void AddToWishList(final String product_id, final LatestProductItemPojo items, final int position, final SparkButton sparkButton)
    {
    ...
    public void RemoveFromWishList(final String product_id, final LatestProductItemPojo items, final int position, final SparkButton sparkButton)
    {
        p_bar.setVisibility(View.VISIBLE);
