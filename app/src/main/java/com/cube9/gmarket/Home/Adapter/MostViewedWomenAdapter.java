...
public class MostViewedWomenAdapter extends RecyclerView.Adapter<MostViewedWomenAdapter.MyViewHolder> {
    ...
    public MostViewedWomenAdapter(List<MostViewedWomenPojo> mostViewedWoMenPojoList, Context context) {
        this.mostViewedWoMenPojoList = mostViewedWoMenPojoList;
        this.context=context;
    }

    @Override
    public MostViewedWomenAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_featured_products_list, parent, false);
        itemView.getLayoutParams().width = (int) (getScreenWidth() /2.0);
        return new MostViewedWomenAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MostViewedWomenAdapter.MyViewHolder holder, int position) {

        final MostViewedWomenPojo items=mostViewedWoMenPojoList.get(position);
        ...
        {
            mostViewedWoMenPojoList.get(position).setRating("0");
        }
    ...
    public int getItemCount() {
        return mostViewedWoMenPojoList.size();
    }
