...
public class DealsPjo {
    ...
    public DealsPjo(String product_id, String product_name, String product_price, String product_image, String product_discount, String product_desc, String wishlist_flag, String quantity_available, String category_id, String product_special_price, String rating, String review_count) {
        this.product_id = product_id;
        this.product_name = product_name;
        this.product_price = product_price;
        this.product_image = product_image;
