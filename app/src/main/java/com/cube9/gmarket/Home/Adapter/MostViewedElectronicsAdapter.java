...
public class MostViewedElectronicsAdapter extends RecyclerView.Adapter<MostViewedElectronicsAdapter.MyViewHolder> {
    ...
    public MostViewedElectronicsAdapter( List<MostViewdElectronics> mostViewdElectronicsList, Context context) {
        this.mostViewdElectronicsList = mostViewdElectronicsList;
        this.context=context;
    }

    @Override
    public MostViewedElectronicsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_featured_products_list, parent, false);
        itemView.getLayoutParams().width = (int) (getScreenWidth() /2.0);
        return new MostViewedElectronicsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MostViewedElectronicsAdapter.MyViewHolder holder, int position) {

        final MostViewdElectronics items=mostViewdElectronicsList.get(position);
        ...
        {
            mostViewdElectronicsList.get(position).setRating("0");
        }
    ...
    public int getItemCount() {
        return mostViewdElectronicsList.size();
    }
